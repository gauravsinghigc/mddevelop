...
//dir & domain setup
define("SERVER", $HOST = $_SERVER['SERVER_NAME']);
...
if (in_array("" . SERVER . "", LOCAL_HOST)) {
  define("DOMAIN", $link . SERVER . "/mddevelop");
} else {
  define("DOMAIN", $link . SERVER);
}

$APP_NAME = "MD DEVELOP BUILD";
$DEV_NAME = "Gaurav Singh";
$DOMAIN = DOMAIN;
$APP_DOMAIN = $DOMAIN;
...
$SENDER_MAIL = "notification@mddevelopbuild.com";
$RECEIVER_MAIL = "gauravsinghigc@gmail.com";
$APP_ADDRESS = "11/7 Opposite Pillar No. 60 Near DS Door, Main Mathura Road, faridabad , Haryana";
$MAP_LINK = "";
$DOWNLOAD_APP_LINK = "";
$DB_OPTION = "true";
$Host = "localhost";
