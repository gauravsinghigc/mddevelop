    ...
    while($Fetch = mysqli_fetch_array($Select)){
     $Count++; ?>
                <tr>
                  ...
                  <td>
                    <?php if($Fetch['status'] == "0") { echo '<span class="btn btn-sm btn-info font-10">Unread</span>';} else {echo '<span class="btn btn-sm btn-success font-10">Read</span>';} ?></span>
                  </td>
                  <td>
                    <a href="tel:<?php echo $Fetch['phone'];?>" class="btn btn-sm btn-info">Call</a>
                    <a href="#" class="btn btn-sm btn-primary" data-toggle="modal"
                      data-target="#view_enq<?php echo $Fetch['enquiryid'];?>">View</a>
                      ...
                      <div class="modal-dialog square modal-lg">
                        <div class="modal-content square">
                          ...
                          <div class="modal-body">
                            ...
                            <h5><b>Phone</b> : <?php echo $Fetch['phone'];?> : <a
                                href="tel:<?php echo $Fetch['phone'];?>" class="btn btn-sm btn-info">Call</a></h5>
                            <h5><b>Email</b> : <?php echo $Fetch['email'];?></h5>
                            <h5><b>Interested In</b> : <?php echo $Fetch['type'];?></h5>
                            <h5><b>Message</b> : <?php echo $Fetch['message'];?></h5>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default square" data-dismiss="modal">Close</button>
                              <a href="../action/update.php?enquiry=<?php echo $Fetch['enquiryid'];?>&status=<?php echo $Fetch['status'];?>"
                                Name="CreateServices" class="btn btn-primary square">Update Status</a>
                            </div>
                          </div>
                        </div>
                        <!-- /.modal-content -->
