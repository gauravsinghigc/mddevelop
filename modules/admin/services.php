    ...
    while($Fetch = mysqli_fetch_array($Select)){
     $Count++; ?>
                <tr>
                  ...
                  <td><img src="<?php echo $Fetch['ServiceImg'];?>" class="img-fluid w-px-20"></td>
                  ...
                  <td>
                    <a href="#" data-toggle="modal" data-target="#view_services<?php echo $Fetch['ServicesId'];?>"
                      class="btn btn-dark btn-sm square"><i class="fa fa-eye"></i></a>
                    <a href="?view=Services&edit=<?php echo $Fetch['ServicesId'];?>"
                      class="btn btn-info btn-sm square"><i class="fa fa-edit"></i></a>
                    <a href="../action/delete.php?services=<?php echo $Fetch['ServicesId'];?>"
                      ...
                      <div class="modal-dialog square modal-lg">
                        <div class="modal-content square">
                          ...
                          <div class="modal-body">
                            ...
                            <img src="<?php echo $Fetch['ServiceImg'];?>" class="img-fluid w-pr-50 d-block mx-auto"><br>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default square" data-dismiss="modal">Close</button>
                              <a href="?view=Services&edit=<?php echo $Fetch['ServicesId'];?>" Name="CreateServices"
