    ...
    while($Fetch = mysqli_fetch_array($Select)){
     $Count++; ?>
                <tr>
                  ...
                  <td>
                    <a href="#" data-toggle="modal" data-target="#view_slider<?php echo $Fetch['sliderid'];?>"
                      class="btn btn-dark btn-sm square"><i class="fa fa-eye"></i></a>
                    <a href="?view=Sliders&edit=<?php echo $Fetch['sliderid'];?>" class="btn btn-info btn-sm square"><i
                        class="fa fa-edit"></i></a>
                    <a href="../action/delete.php?Sliders=<?php echo $Fetch['sliderid'];?>"
                      ...
                      <div class="modal-dialog square modal-lg">
                        <div class="modal-content square">
                          ...
                          <div class="modal-body">
                            ...
                            <img src="<?php echo $Fetch['sliderimg'];?>" class="img-fluid w-pr-50 d-block mx-auto"><br>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default square" data-dismiss="modal">Close</button>
                              <a href="?view=Sliders&edit=<?php echo $Fetch['sliderid'];?>" Name="CreateServices"
                                class="btn btn-primary square">Edit Slider</a>
                            </div>
                          </div>
                        </div>
                        <!-- /.modal-content -->
