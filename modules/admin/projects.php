    ...
    while($Fetch = mysqli_fetch_array($Select)){
     $Count++; ?>
                <tr>
                  ...
                  <td><img src="<?php echo $Fetch['ProjectsImg'];?>" class="img-fluid w-px-20"></td>
                  ...
                  <td>
                    <a href="#" data-toggle="modal" data-target="#view_projects<?php echo $Fetch['ProjectsId'];?>"
                      class="btn btn-dark btn-sm square"><i class="fa fa-eye"></i></a>
                    <a href="?view=Projects&edit=<?php echo $Fetch['ProjectsId'];?>"
                      class="btn btn-info btn-sm square"><i class="fa fa-edit"></i></a>
                    <a href="../action/delete.php?projects=<?php echo $Fetch['ProjectsId'];?>"
                      ...
                      <div class="modal-dialog square modal-lg">
                        <div class="modal-content square">
                          ...
                          <div class="modal-body">
                            ...
                            <img src="<?php echo $Fetch['ProjectsImg'];?>"
                              class="img-fluid w-pr-50 d-block mx-auto"><br>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default square" data-dismiss="modal">Close</button>
                              <a href="?view=Projects&edit=<?php echo $Fetch['ProjectsId'];?>" Name="CreateServices"
                                class="btn btn-primary square">Edit Service</a>
                            </div>
                          </div>
                        </div>
                        <!-- /.modal-content -->
        ...
        <div class="modal-body">
          <form action="../action/insert.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <label for="ServiceTitle"> Project Title</label>
              <input type="text" name="ProjectsTitle" class="form-control" required="">
            </div>
            <div class="form-group">
              <label for="ServiceImg"> Project Image</label>
              <input type="FILE" name="ProjectsImg" class="form-control" required="">
            </div>
            <div class="form-group">
              <label for="ServiceDesc">Project Description</label>
