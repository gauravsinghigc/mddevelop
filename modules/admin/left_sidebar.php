...
<aside class="main-sidebar sidebar-light-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <span class="brand-image img-circle elevation-1"
      style="opacity: .8;padding: 4%;"><?php echo substr(CONFIG("APP_NAME"), 0, 1);?></span>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="index.php?view=Live Projects" class="nav-link">
            <i class="nav-icon fas fa-table"></i>
            <p>
              Live Projects
            </p>
