    ...
    <div class="row pt-5">
      <div class="col-lg-4 col-md-6 col-sm-8 col-10 square bg-light d-block mx-auto shadow-sm p-3 mt-5">
        ...
        <form class="form p-2 mt-2" action="action/auth.php" method="POST">
          ...
          <div class="form-group">
            <input type="email" name="EmailId" value="" oninput="CheckInputs()" class="form-control" required=""
              placeholder="Enter Your Mail Id">
          </div>
          <div class="form-group">
            <button type="submit" name="ForgetPassword" onclick="LoginClick()" id="LoginAction"
              class="btn btn-block bg-info form-control text-white square btn-p">Recover Password</button>
          </div>
          ...
          <div class="form-group text-center">
            <p class="font-13 text-center text-black">
              ...
              <span class="text-grey">Powered By <a href="http://gauravsinghigc.epizy.com"
                  class="text-decoration-none text-grey">GauravsinghigC</a></span>
            </p>
          </div>
        </form>
      </div>
