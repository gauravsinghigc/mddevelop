    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-11">
          <a href="<?php echo $FetchServices['ProjectsImg'];?>" target="blank">
            <img src="<?php echo $FetchServices['ProjectsImg'];?>" class="img-fluid">
          </a>

          <a href="<?php echo $FetchServices['ProjectsImg'];?>" class="btn btn-primary btn-md mb-0"
            download="<?php echo $FetchServices['ProjectsImg'];?>" target="blank">
