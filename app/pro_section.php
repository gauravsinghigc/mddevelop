  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-md-4 col-sm-6 col-12">
        <div class="bg-light p-2">
          <div class="img-fluid">
            <img src="<?php echo $FetchServices['ProjectsImg'];?>" style="height: 13.7rem;">
          </div>
    ...
    overflow: hidden;">
          ...
          <div class="mbr-section-btn">
            <a href="project_details.php?id=<?php echo $FetchServices['ProjectsId'];?>"
              class="btn btn-primary display-4">View Project</a>
          </div>
        </div>
      </div>
      <?php }
