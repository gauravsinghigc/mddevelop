    ...
    <div class="media-container-row align-center mbr-white">
      <div class="row row-links">
        <ul class="foot-menu">
          ...
          <li class="foot-menu-item mbr-fonts-style display-8">
            <a class="text-white" href="http://plotmanagement.in/customer" target="blank">Customer Login</a>
          </li>
          <li class="foot-menu-item mbr-fonts-style display-8">
            <a class="text-white" href="http://plotmanagement.in/" target="blank">Admin Login</a>
          </li>
          <li class="foot-menu-item mbr-fonts-style display-8">
            <a class="text-white" href="http://plotmanagement.in/agent" target="blank">Agent Login</a>
          </li>
        </ul>
      </div>
...
<a href="https://wa.me/91<?php echo CONFIG("APP_PHONE"); ?>" data-action="share/whatsapp/share" onClick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on whatsapp" class="float_w" target="_blank">
  <span>
