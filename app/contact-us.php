...
<body>
  <?php include 'header.php'; BODY_FILES(); ?>
    ...
    <div class="container">
      <div class="row justify-content-center mt-0">
        <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
          ...
          <hr>
          <form action="../action/insert.php" method="POST" class="mbr-form form-with-styler"
            data-form-title="Form Name">

            <div class="dragArea row">
              <div class="col-md-6 col-sm-12 form-group" data-for="name">
                <input type="text" name="FullName" placeholder="Name" data-form-field="name" class="form-control"
                  value="" id="name-form5-p">
              </div>
              <div class="col-md-6 col-sm-12 form-group" data-for="email">
                <input type="email" name="email" placeholder="E-mail" data-form-field="email" class="form-control"
                  value="" id="email-form5-p">
              </div>
              <div class="col-12 form-group" data-for="url">
                <input type="text" name="phone" placeholder="Phone" data-form-field="phone" class="form-control"
                  value="">
              </div>
              <div class="col-12 form-group" data-for="url">
              ...
              <div class="col-12 form-group" data-for="textarea">
                <textarea name="message" placeholder="Message" rows="6" data-form-field="textarea" class="form-control"
                  id="textarea-form5-p"></textarea>
              </div>
