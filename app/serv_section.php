  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-lg-12 col-md-12 col-12 col-sm-12 text-center pb-4">
        ...
        <p>We provide various type of real state services, lands, plots, flats, residential & commercial property.</p>
      </div>
      <?php 
        ...
        <div class="card-wrapper mbr-flex">
          <div class="card-box align-left">
            ...
            <div class="mbr-section-btn">
              <a href="service_details.php?id=<?php echo $FetchServices['ServicesId'];?>"
                class="btn btn-primary display-4">Know More...</a>
            </div>
          </div>
          <div class="img-wrapper img2 align-center"
            style="background-image:url('<?php echo $FetchServices['ServiceImg'];?>');">
            <img src="<?php echo $FetchServices['ServiceImg'];?>">
          </div>
        </div>
      </div>
